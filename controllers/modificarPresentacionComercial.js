...
$scope.submit = function () {
	...
	var request = {
			method: 'POST',
			url: baseUrl,
			data: {id: $scope.selectedOption, namePresentacionComercial: $scope.nombre, descriptionPresentacionComercial: $scope.descripcion, estadoPresentacionComercial: $scope.estado}
	};

...
var request = {
			method: 'POST',
			url: baseUrl,
			data: {id: $scope.selectedOption,nameCategoriaMedicamento: $scope.nombre, descriptionCategoriaMedicamento: $scope.descripcion, estadoCategoriaMedicamento: $scope.estado}
	};
